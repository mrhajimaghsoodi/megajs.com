...
1. اول Staging را کامل تست کنید.  
2. سرور **جدید** برای پلتفرم MEGA JS آماده کنید (یا همان سرور با پورت/کانتینر جدا).  
3. DNS را فقط وقتی آماده بودید سوییچ کنید (TTL را از قبل کم کنید، مثلاً ۳۰۰ ثانیه).  
4. وردپرس را آرشیو/بک‌آپ بگیرید؛ مهاجرت محتوا لازم نیست (از صفر ساخته‌اید).
