---
title: "Vue.js: Syntax قالب"
description: "Vue.js — Syntax قالب"
order: 2
sources:
  - name: Vue.js Docs
...
این صفحه بخشی از مسیر مستندات **Vue.js** در MEGA JS است.
...
console.log('Vue.js / template-syntax');
```
