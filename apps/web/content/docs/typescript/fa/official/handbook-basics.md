---
title: "Basics در Handbook"
description: "این صفحه خواندن پایه‌های Handbook: value، type، annotation و feedback compiler را با مثال TypeScript، جدول syntax و نکته‌های کاربردی برای authoring توضیح می‌دهد."
seoTitle: "Basics در Handbook - مستندات رسمی TypeScript | MEGA JS"
seoDescription: "Basics در Handbook (handbook basics): خلاصه رسمی TypeScript Docs با Handbook، Reference، Modules، declaration file، tsconfig و نکته compiler همراه تمرین."
keywords: "TypeScript, Basics در Handbook, آموزش TypeScript, مرجع TypeScript, TypeScript Handbook Basics, Handbook Basics tutorial, handbook basics"
order: 5
track: official
sources:
...
Basics در Handbook خلاصه‌ای از ساختار رسمی typescriptlang.org/docs است. تمرکز آن روی خواندن پایه‌های Handbook: value، type، annotation و feedback compiler است و هدف آن کمک به author برای خواندن Handbook و Reference بدون تبدیل صفحه به dump کامل مستندات است.
...
- در Basics در Handbook، caveatهای official را با نسخه TypeScript، گزینه‌های tsconfig و runtime واقعی JavaScript مقایسه کنید.
...
ادامه track رسمی: **Everyday Types**.
