---
title: "Electron: Main & renderer"
description: "Electron — Main & renderer"
order: 2
sources:
  - name: Electron Docs
...
This page is part of the **Electron** documentation track on MEGA JS.
...
- Core concepts for **Main & renderer**
...
console.log('Electron / main-renderer');
```

> Edit only the files under `content/docs/electron/` to change this technology independently.
