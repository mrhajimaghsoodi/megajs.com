---
title: "Angular: کامپوننت‌ها"
description: "Angular — کامپوننت‌ها"
order: 2
sources:
  - name: Angular Docs
...
این صفحه بخشی از مسیر مستندات **Angular** در MEGA JS است.
...
console.log('Angular / components');
```
