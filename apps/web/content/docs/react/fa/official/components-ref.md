---
title: "مرجع Componentهای داخلی"
description: "این صفحه Fragment، Profiler، StrictMode و Suspense به عنوان componentهای رسمی React را با مثال React، جدول syntax و نکته‌های کاربردی برای component authoring توضیح می‌دهد."
seoTitle: "مرجع Componentهای داخلی — مرجع رسمی react.dev | MEGA JS"
seoDescription: "مرجع Componentهای داخلی (components ref): خلاصه رسمی react.dev برای React API Reference با Hooks، Components، React DOM، Compiler و Rules of React."
keywords: "React, مرجع Componentهای داخلی, آموزش React, مرجع React, React Built-in Components Reference, Built-in Components Reference tutorial, components ref"
order: 14
track: official
sources:
  ...
  - name: React Docs
    url: https://react.dev/
---
# مرجع Componentهای داخلی

مرجع Componentهای داخلی خلاصه‌ای از ساختار رسمی react.dev/reference است. تمرکز آن روی Fragment، Profiler، StrictMode و Suspense به عنوان componentهای رسمی React است و هدف آن کمک به author برای خواندن API Reference بدون تبدیل کردن صفحه به dump کامل مستندات است.
...
| --- | --- |
| `ref` | reference به DOM node یا value mutable |
| `React DOM` | package مربوط به React برای render در DOM مرورگر |
| `createRoot` | root مرورگر برای React می‌سازد |
...
<html lang="en">
  <head>
    ...
    <title>Built-in Components Reference official</title>
      ...
      function App() {
        return (
          <section className="card">
            <h1>Built-in Components Reference reading trace</h1>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Built-in Components Reference</title>
    <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <style>
  ...
  <body>
    ...
    <script type="text/babel">
      ...
      function App() {
        ...
        return (
          <section className="card">
            <h1>Built-in Components Reference</h1>
...
- در مرجع Componentهای داخلی، caveatهای official را با نسخه React، mode توسعه مثل StrictMode و test واقعی مقایسه کنید.
...
ادامه track رسمی: **مرجع APIهای React**.
