---
title: "مرجع useReducer"
description: "این صفحه مدیریت state پیچیده با reducer، action، dispatch و initializer function را با مثال React، جدول syntax و نکته‌های کاربردی برای component authoring توضیح می‌دهد."
seoTitle: "مرجع useReducer — مرجع رسمی react.dev | MEGA JS"
seoDescription: "مرجع useReducer (usereducer ref): خلاصه رسمی react.dev برای React API Reference با Hooks، Components، React DOM، Compiler و Rules of React همراه تمرین کاربردی."
keywords: "React, مرجع useReducer, آموزش React, مرجع React, React useReducer Reference, useReducer Reference tutorial, usereducer ref"
order: 4
track: official
sources:
...
مرجع useReducer خلاصه‌ای از ساختار رسمی react.dev/reference است. تمرکز آن روی مدیریت state پیچیده با reducer، action، dispatch و initializer function است و هدف آن کمک به author برای خواندن API Reference بدون تبدیل کردن صفحه به dump کامل مستندات است.
...
<html lang="en">
  <head>
    ...
    <title>useReducer Reference official</title>
      ...
      function App() {
        return (
          <section className="card">
            <h1>useReducer Reference reading trace</h1>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>useReducer Reference</title>
    <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <style>
...
- در مرجع useReducer، caveatهای official را با نسخه React، mode توسعه مثل StrictMode و test واقعی مقایسه کنید.
...
ادامه track رسمی: **مرجع useContext**.
