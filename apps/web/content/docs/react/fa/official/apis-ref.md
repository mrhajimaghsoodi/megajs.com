---
title: "مرجع APIهای React"
description: "این صفحه APIهای core مثل createContext، lazy، memo، startTransition، use و موارد مرتبط را با مثال React، جدول syntax و نکته‌های کاربردی برای component authoring توضیح می‌دهد."
seoTitle: "مرجع APIهای React — مرجع رسمی react.dev | MEGA JS"
seoDescription: "مرجع APIهای React (apis ref): خلاصه رسمی react.dev برای React API Reference با Hooks، Components، React DOM، Compiler و Rules of React همراه تمرین کاربردی."
keywords: "React, مرجع APIهای React, آموزش React, مرجع React, React APIs Reference, APIs Reference tutorial, apis ref"
order: 15
track: official
sources:
...
مرجع APIهای React خلاصه‌ای از ساختار رسمی react.dev/reference است. تمرکز آن روی APIهای core مثل createContext، lazy، memo، startTransition، use و موارد مرتبط است و هدف آن کمک به author برای خواندن API Reference بدون تبدیل کردن صفحه به dump کامل مستندات است.
...
<html lang="en">
  <head>
    ...
    <title>React APIs Reference official</title>
      ...
      function App() {
        return (
          <section className="card">
            <h1>React APIs Reference reading trace</h1>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>React APIs Reference</title>
    <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <style>
...
- در مرجع APIهای React، caveatهای official را با نسخه React، mode توسعه مثل StrictMode و test واقعی مقایسه کنید.
...
ادامه track رسمی: **مرجع React DOM**.
