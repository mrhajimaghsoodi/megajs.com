---
title: "مرجع useRef"
description: "این صفحه نگه‌داری reference mutable، DOM node و valueهایی که نباید render را trigger کنند را با مثال React، جدول syntax و نکته‌های کاربردی برای component authoring توضیح می‌دهد."
seoTitle: "مرجع useRef — مرجع رسمی react.dev | MEGA JS"
seoDescription: "مرجع useRef (useref ref): خلاصه رسمی react.dev برای React API Reference با Hooks، Components، React DOM، Compiler و Rules of React همراه تمرین کاربردی."
keywords: "React, مرجع useRef, آموزش React, مرجع React, React useRef Reference, useRef Reference tutorial, useref ref"
order: 6
track: official
sources:
...
مرجع useRef خلاصه‌ای از ساختار رسمی react.dev/reference است. تمرکز آن روی نگه‌داری reference mutable، DOM node و valueهایی که نباید render را trigger کنند است و هدف آن کمک به author برای خواندن API Reference بدون تبدیل کردن صفحه به dump کامل مستندات است.
...
<html lang="en">
  <head>
    ...
    <title>useRef Reference official</title>
      ...
      function App() {
        return (
          <section className="card">
            <h1>useRef Reference reading trace</h1>
...
- در مرجع useRef، caveatهای official را با نسخه React، mode توسعه مثل StrictMode و test واقعی مقایسه کنید.
...
ادامه track رسمی: **مرجع useEffect**.
