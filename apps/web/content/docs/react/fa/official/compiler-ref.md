---
title: "مرجع React Compiler"
description: "این صفحه حوزه رسمی compiler، directiveها، انتظارهای lint و مدل optimization را با مثال React، جدول syntax و نکته‌های کاربردی برای component authoring توضیح می‌دهد."
seoTitle: "مرجع React Compiler — مرجع رسمی react.dev | MEGA JS"
seoDescription: "مرجع React Compiler (compiler ref): خلاصه رسمی react.dev برای React API Reference با Hooks، Components، React DOM، Compiler و Rules of React همراه تمرین."
keywords: "React, مرجع React Compiler, آموزش React, مرجع React, React Compiler Reference, Compiler Reference tutorial, compiler ref"
order: 17
track: official
sources:
...
مرجع React Compiler خلاصه‌ای از ساختار رسمی react.dev/reference است. تمرکز آن روی حوزه رسمی compiler، directiveها، انتظارهای lint و مدل optimization است و هدف آن کمک به author برای خواندن API Reference بدون تبدیل کردن صفحه به dump کامل مستندات است.
...
<html lang="en">
  <head>
    ...
    <title>React Compiler Reference official</title>
      ...
      function App() {
        return (
          <section className="card">
            <h1>React Compiler Reference reading trace</h1>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>React Compiler Reference</title>
    <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <style>
  ...
  <body>
    ...
    <script type="text/babel">
      ...
      function App() {
        ...
        return (
          <section className="card">
            <h1>React Compiler Reference</h1>
...
- در مرجع React Compiler، caveatهای official را با نسخه React، mode توسعه مثل StrictMode و test واقعی مقایسه کنید.
...
ادامه track رسمی: **Rules of React**.
