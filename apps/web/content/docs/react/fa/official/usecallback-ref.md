---
title: "مرجع useCallback"
description: "این صفحه cache کردن identity function برای childهای memoized و dependencyهای Effect را با مثال React، جدول syntax و نکته‌های کاربردی برای component authoring توضیح می‌دهد."
seoTitle: "مرجع useCallback — مرجع رسمی react.dev | MEGA JS"
seoDescription: "مرجع useCallback (usecallback ref): خلاصه رسمی react.dev برای React API Reference با Hooks، Components، React DOM، Compiler و Rules of React همراه تمرین."
keywords: "React, مرجع useCallback, آموزش React, مرجع React, React useCallback Reference, useCallback Reference tutorial, usecallback ref"
order: 9
track: official
sources:
...
مرجع useCallback خلاصه‌ای از ساختار رسمی react.dev/reference است. تمرکز آن روی cache کردن identity function برای childهای memoized و dependencyهای Effect است و هدف آن کمک به author برای خواندن API Reference بدون تبدیل کردن صفحه به dump کامل مستندات است.
...
<html lang="en">
  <head>
    ...
    <title>useCallback Reference official</title>
      ...
      function App() {
        return (
          <section className="card">
            <h1>useCallback Reference reading trace</h1>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>useCallback Reference</title>
    <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <style>
...
- در مرجع useCallback، caveatهای official را با نسخه React، mode توسعه مثل StrictMode و test واقعی مقایسه کنید.
...
ادامه track رسمی: **مرجع useTransition**.
