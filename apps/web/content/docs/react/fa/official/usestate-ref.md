---
title: "مرجع useState"
description: "این صفحه تعریف state variable، updater function، initializer function و patternهای reset را با مثال React، جدول syntax و نکته‌های کاربردی برای component authoring توضیح می‌دهد."
seoTitle: "مرجع useState — مرجع رسمی react.dev | MEGA JS"
seoDescription: "مرجع useState (usestate ref): خلاصه رسمی react.dev برای React API Reference با Hooks، Components، React DOM، Compiler و Rules of React همراه تمرین کاربردی."
keywords: "React, مرجع useState, آموزش React, مرجع React, React useState Reference, useState Reference tutorial, usestate ref"
order: 3
track: official
sources:
...
مرجع useState خلاصه‌ای از ساختار رسمی react.dev/reference است. تمرکز آن روی تعریف state variable، updater function، initializer function و patternهای reset است و هدف آن کمک به author برای خواندن API Reference بدون تبدیل کردن صفحه به dump کامل مستندات است.
...
<html lang="en">
  <head>
    ...
    <title>useState Reference official</title>
      ...
      function App() {
        return (
          <section className="card">
            <h1>useState Reference reading trace</h1>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>useState Reference</title>
    <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <style>
...
- در مرجع useState، caveatهای official را با نسخه React، mode توسعه مثل StrictMode و test واقعی مقایسه کنید.
...
ادامه track رسمی: **مرجع useReducer**.
