---
title: "مرجع useTransition"
description: "این صفحه علامت‌گذاری state update به عنوان transition غیر blocking همراه pending UI را با مثال React، جدول syntax و نکته‌های کاربردی برای component authoring توضیح می‌دهد."
seoTitle: "مرجع useTransition — مرجع رسمی react.dev | MEGA JS"
seoDescription: "مرجع useTransition (usetransition ref): خلاصه رسمی react.dev برای React API Reference با Hooks، Components، React DOM، Compiler و Rules of React."
keywords: "React, مرجع useTransition, آموزش React, مرجع React, React useTransition Reference, useTransition Reference tutorial, usetransition ref"
order: 10
track: official
sources:
...
مرجع useTransition خلاصه‌ای از ساختار رسمی react.dev/reference است. تمرکز آن روی علامت‌گذاری state update به عنوان transition غیر blocking همراه pending UI است و هدف آن کمک به author برای خواندن API Reference بدون تبدیل کردن صفحه به dump کامل مستندات است.
...
| --- | --- |
| `state` | memory component که روی render اثر دارد |
| `update` | درخواست برای render دوباره React |
| `render` | call کردن componentها برای محاسبه UI |
...
<html lang="en">
  <head>
    ...
    <title>useTransition Reference official</title>
      ...
      function App() {
        return (
          <section className="card">
            <h1>useTransition Reference reading trace</h1>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>useTransition Reference</title>
    <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <style>
...
- در مرجع useTransition، caveatهای official را با نسخه React، mode توسعه مثل StrictMode و test واقعی مقایسه کنید.
...
ادامه track رسمی: **مرجع useDeferredValue**.
