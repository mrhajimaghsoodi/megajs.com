---
title: "Catalog مرجع Hooks"
description: "این صفحه categoryهای رسمی برای Hooks داخلی و زمان استفاده از هر خانواده را با مثال React، جدول syntax و نکته‌های کاربردی برای component authoring توضیح می‌دهد."
seoTitle: "Catalog مرجع Hooks — مرجع رسمی react.dev | MEGA JS"
seoDescription: "Catalog مرجع Hooks (hooks ref): خلاصه رسمی react.dev برای React API Reference با Hooks، Components، React DOM، Compiler و Rules of React همراه تمرین کاربردی."
keywords: "React, Catalog مرجع Hooks, آموزش React, مرجع React, React Hooks Reference Catalog, Hooks Reference Catalog tutorial, hooks ref"
order: 2
track: official
sources:
...
Catalog مرجع Hooks خلاصه‌ای از ساختار رسمی react.dev/reference است. تمرکز آن روی categoryهای رسمی برای Hooks داخلی و زمان استفاده از هر خانواده است و هدف آن کمک به author برای خواندن API Reference بدون تبدیل کردن صفحه به dump کامل مستندات است.
...
<html lang="en">
  <head>
    ...
    <title>Hooks Reference Catalog official</title>
      ...
      function App() {
        return (
          <section className="card">
            <h1>Hooks Reference Catalog reading trace</h1>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Hooks Reference Catalog</title>
    <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <style>
...
- در Catalog مرجع Hooks، caveatهای official را با نسخه React، mode توسعه مثل StrictMode و test واقعی مقایسه کنید.
...
ادامه track رسمی: **مرجع useState**.
