---
title: "نمای کلی Hooks در مرجع"
description: "این صفحه ruleها، categoryها و انتظارهای authoring پیرامون Hooks در React را با مثال React، جدول syntax و نکته‌های کاربردی برای component authoring توضیح می‌دهد."
seoTitle: "نمای کلی Hooks در مرجع — سبک MDN برای React | MEGA JS"
seoDescription: "نمای کلی Hooks در مرجع (hooks overview ref): مرجع MDN-style برای React با تعریف author-focused، JSX، Hooks، مثال HTML و نکته پروژه واقعی همراه تمرین کاربردی."
keywords: "React, نمای کلی Hooks در مرجع, آموزش React, مرجع React, React Hooks Overview Reference, Hooks Overview Reference tutorial, hooks overview ref"
order: 9
track: reference
sources:
...
---
# نمای کلی Hooks در مرجع

نمای کلی Hooks در مرجع یک صفحه مرجع author-focused به سبک MDN است. تمرکز آن روی ruleها، categoryها و انتظارهای authoring پیرامون Hooks در React است و به جای آموزش قدم‌به‌قدم، تعریف دقیق، جدول کاربرد، behavior در runtime و boundaryهای component را کنار هم می‌گذارد.

## جایگاه در MDN

در MDN، React در بخش Client-side JavaScript frameworks کنار مفهوم component، props، state، event، form، accessibility و testing توضیح داده می‌شود. هنگام استفاده از نمای کلی Hooks در مرجع، رفتار React را از behavior خام DOM و ابزار build جدا ببینید.
...
<html lang="en">
  <head>
    ...
    <title>Hooks Overview Reference reference</title>
      ...
      function App() {
        return (
          <article className="card">
            <h1>Hooks Overview Reference</h1>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Hooks Overview Reference</title>
    <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <style>
...
- برای نمای کلی Hooks در مرجع، data flow بین props، state و context را explicit نگه دارید.
...
این صفحه به موضوعات MDN درباره Hooks Overview Reference, React framework guides, accessibility و testing نزدیک است و برای مرور سریع قبل از پیاده‌سازی طراحی شده است.

## گام بعدی

صفحه مرجع بعدی: **مرجع چرخه Effect**.
