...
description: "This page explains how MDN-style React framework docs organize components, JSX, state, effects, testing, and deployment decisions with React examples, syntax tables, and practical component authoring notes."
seoTitle: "React Reference Overview — MDN-style React | MEGA JS Docs"
seoDescription: "React Reference Overview (overview): MDN-style React reference with author-focused definitions, JSX, Hooks, HTML examples, and project notes with practical."
keywords: "React, React Reference Overview, React reference, MDN React, React docs"
order: 1
track: reference
sources:
...
React Reference Overview is an author-focused MDN-style React reference page. It concentrates on how MDN-style React framework docs organize components, JSX, state, effects, testing, and deployment decisions and favors precise definitions, usage tables, runtime behavior, and component boundaries over beginner sequencing.

## Place in the MDN reference

On MDN, React appears in the Client-side JavaScript frameworks material near components, props, state, events, forms, accessibility, and testing. When using React Reference Overview, separate React behavior from raw DOM behavior and build tooling.

## Reference table

| Item | Meaning | Compatibility note |
| --- | --- | --- |
| `React` | library feature used in React Reference Overview | Check it in target browsers, tests, accessibility checks, and the real Console. |
...
- For React Reference Overview, keep data flow between props, state, and context explicit.
...
This page aligns with MDN topics around React Reference Overview, React framework guides, accessibility, and testing before implementation.

## Next step

Continue with **React Component Model**.
