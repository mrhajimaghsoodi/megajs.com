...
description: "This page explains keeping mutable references, DOM nodes, and values that should not trigger rendering with React examples, syntax tables, and practical component authoring notes."
seoTitle: "useRef Reference — Official react.dev Reference | MEGA JS Docs"
seoDescription: "useRef Reference (useref ref): official react.dev React API Reference summary with Hooks, Components, React DOM, Compiler, and Rules of React with practical."
keywords: "React, useRef Reference, React useRef Reference, useRef Reference tutorial, useref ref"
order: 6
track: official
sources:
...
useRef Reference summarizes the official react.dev/reference structure. It focuses on keeping mutable references, DOM nodes, and values that should not trigger rendering and helps authors read the API Reference without turning this page into a full documentation dump.
...
- In useRef Reference, compare official caveats with your React version, development mode such as StrictMode, and real tests.
...
Continue the official track with **useEffect Reference**.
