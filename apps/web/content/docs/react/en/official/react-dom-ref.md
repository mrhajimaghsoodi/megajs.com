---
title: "React DOM Reference"
description: "This page explains client createRoot and hydrateRoot plus server rendering APIs for React DOM with React examples, syntax tables, and practical component authoring notes."
seoTitle: "React DOM Reference — Official react.dev Reference | MEGA JS Docs"
seoDescription: "React DOM Reference (react dom ref): official react.dev React API Reference summary with Hooks, Components, React DOM, Compiler, and Rules of React."
keywords: "React, React DOM Reference, React DOM Reference, DOM Reference tutorial, react dom ref"
order: 16
track: official
sources:
...
React DOM Reference summarizes the official react.dev/reference structure. It focuses on client createRoot and hydrateRoot plus server rendering APIs for React DOM and helps authors read the API Reference without turning this page into a full documentation dump.
...
<html lang="en">
  <head>
    ...
    <title>React DOM Reference official</title>
      ...
      function App() {
        return (
          <section className="card">
            <h1>React DOM Reference reading trace</h1>
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>React DOM Reference</title>
    <script crossorigin src="https://unpkg.com/react@18/umd/react.development.js"></script>
    <script crossorigin src="https://unpkg.com/react-dom@18/umd/react-dom.development.js"></script>
    <script src="https://unpkg.com/@babel/standalone/babel.min.js"></script>
    <style>
...
- In React DOM Reference, compare official caveats with your React version, development mode such as StrictMode, and real tests.
...
Continue the official track with **React Compiler Reference**.
