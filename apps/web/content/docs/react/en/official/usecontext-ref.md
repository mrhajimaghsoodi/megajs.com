...
description: "This page explains reading context values, provider placement, fallback defaults, and rerender implications with React examples, syntax tables, and practical component authoring notes."
seoTitle: "useContext Reference — Official react.dev Reference | MEGA JS Docs"
seoDescription: "useContext Reference (usecontext ref): official react.dev React API Reference summary with Hooks, Components, React DOM, Compiler, and Rules of React."
keywords: "React, useContext Reference, React useContext Reference, useContext Reference tutorial, usecontext ref"
order: 5
track: official
sources:
  ...
  - name: React Docs
    url: https://react.dev/
---
# useContext Reference

useContext Reference summarizes the official react.dev/reference structure. It focuses on reading context values, provider placement, fallback defaults, and rerender implications and helps authors read the API Reference without turning this page into a full documentation dump.
...
| --- | --- |
| `createContext` | creates a context for shared values |
| `Provider` | supplies context to descendants |
| `useContext` | reads context from a component |
...
- In useContext Reference, compare official caveats with your React version, development mode such as StrictMode, and real tests.
...
Continue the official track with **useRef Reference**.
