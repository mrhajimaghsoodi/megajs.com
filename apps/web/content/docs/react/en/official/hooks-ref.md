---
title: "Hooks Reference Catalog"
description: "This page explains the official categories for built-in Hooks and when each family is used with React examples, syntax tables, and practical component authoring notes."
seoTitle: "Hooks Reference Catalog — Official react.dev Reference | MEGA JS Docs"
seoDescription: "Hooks Reference Catalog (hooks ref): official react.dev React API Reference summary with Hooks, Components, React DOM, Compiler, and Rules of React."
keywords: "React, Hooks Reference Catalog, React Hooks Reference Catalog, Hooks Reference Catalog tutorial, hooks ref"
order: 2
track: official
sources:
  ...
  - name: React Docs
    url: https://react.dev/
---
# Hooks Reference Catalog

Hooks Reference Catalog summarizes the official react.dev/reference structure. It focuses on the official categories for built-in Hooks and when each family is used and helps authors read the API Reference without turning this page into a full documentation dump.
...
- In Hooks Reference Catalog, compare official caveats with your React version, development mode such as StrictMode, and real tests.
...
Continue the official track with **useState Reference**.
