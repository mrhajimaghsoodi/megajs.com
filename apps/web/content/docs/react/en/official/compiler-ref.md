...
description: "This page explains the official compiler area, directives, linting expectations, and optimization model with React examples, syntax tables, and practical component authoring notes."
seoTitle: "React Compiler Reference — Official react.dev Reference | MEGA JS Docs"
seoDescription: "React Compiler Reference (compiler ref): official react.dev React API Reference summary with Hooks, Components, React DOM, Compiler, and Rules of React."
keywords: "React, React Compiler Reference, React Compiler Reference, Compiler Reference tutorial, compiler ref"
order: 17
track: official
sources:
...
React Compiler Reference summarizes the official react.dev/reference structure. It focuses on the official compiler area, directives, linting expectations, and optimization model and helps authors read the API Reference without turning this page into a full documentation dump.
...
- In React Compiler Reference, compare official caveats with your React version, development mode such as StrictMode, and real tests.
...
Continue the official track with **Rules of React**.
