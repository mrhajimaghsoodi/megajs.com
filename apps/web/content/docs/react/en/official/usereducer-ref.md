...
description: "This page explains managing complex state with reducers, actions, dispatch, and initializer functions with React examples, syntax tables, and practical component authoring notes."
seoTitle: "useReducer Reference — Official react.dev Reference | MEGA JS Docs"
seoDescription: "useReducer Reference (usereducer ref): official react.dev React API Reference summary with Hooks, Components, React DOM, Compiler, and Rules of React."
keywords: "React, useReducer Reference, React useReducer Reference, useReducer Reference tutorial, usereducer ref"
order: 4
track: official
sources:
...
useReducer Reference summarizes the official react.dev/reference structure. It focuses on managing complex state with reducers, actions, dispatch, and initializer functions and helps authors read the API Reference without turning this page into a full documentation dump.
...
- In useReducer Reference, compare official caveats with your React version, development mode such as StrictMode, and real tests.
...
Continue the official track with **useContext Reference**.
