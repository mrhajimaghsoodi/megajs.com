...
description: "This page explains Fragment, Profiler, StrictMode, and Suspense as official React components with React examples, syntax tables, and practical component authoring notes."
seoTitle: "Built-in Components Reference — Official react.dev Reference | MEGA JS Docs"
seoDescription: "Built-in Components Reference (components ref): official react.dev React API Reference summary with Hooks, Components, React DOM, Compiler, and Rules of React."
keywords: "React, Built-in Components Reference, React Built-in Components Reference, Built-in Components Reference tutorial, components ref"
order: 14
track: official
sources:
...
Built-in Components Reference summarizes the official react.dev/reference structure. It focuses on Fragment, Profiler, StrictMode, and Suspense as official React components and helps authors read the API Reference without turning this page into a full documentation dump.
...
- In Built-in Components Reference, compare official caveats with your React version, development mode such as StrictMode, and real tests.
...
Continue the official track with **React APIs Reference**.
