---
title: "Lodash: Collectionها"
description: "Lodash — Collectionها"
order: 2
sources:
  - name: Lodash Docs
...
این صفحه بخشی از مسیر مستندات **Lodash** در MEGA JS است.
...
console.log('Lodash / collections');
```
